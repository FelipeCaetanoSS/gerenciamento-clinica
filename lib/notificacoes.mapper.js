const { formatarDataHoraClinica } = require("./timezone");
...
function mapNotificacao(notificacao, overrides = {}) {
  ...
  const dataHorarioBrasilia = notificacao.data ? formatarDataHoraClinica(notificacao.data) : "";
  ...
  return {
    ...
    createdAt: data,
    criadoEm: data,
    timeHorarioBrasilia: dataHorarioBrasilia,
    criadoEmHorarioBrasilia: dataHorarioBrasilia,
    read: lida,
    lida,
    lido: lida,
    visualizada: lida,
